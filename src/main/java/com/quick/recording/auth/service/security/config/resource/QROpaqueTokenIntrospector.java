...
import com.quick.recording.auth.service.security.config.resource.ResourceServerProperties;
...
public class QROpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    public QROpaqueTokenIntrospector(@Autowired ResourceServerProperties resourceServerProperties) throws URISyntaxException {
